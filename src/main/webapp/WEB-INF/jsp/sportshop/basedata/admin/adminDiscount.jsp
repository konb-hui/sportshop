...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/adminDiscount.js"></script>
...
<body>
<div class="modal fade" id="update-discount" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content" id="parentModal">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">修改优惠券</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" id="update-form" name="update-form" method="post">
                   <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <span id="updatedid" class="form-control"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="fullprice" class="col-sm-2 control-label">满</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="updatefullprice" id="updatefullprice">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="reduceprice" class="col-sm-2 control-label">减</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="updatereduceprice" id="updatereduceprice">
                        </div>
                    </div>
                </form>
            </div>
...
<div class="modal fade" id="add-discount" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content" id="parentModal">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">增加优惠券</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" id="add-form" name="add-form" method="post">
                    <div class="form-group">
                        <label for="fullprice" class="col-sm-2 control-label">满</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="addfullprice" id="addfullprice">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="reduceprice" class="col-sm-2 control-label">减</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="addreduceprice" id="addreduceprice">
                        </div>
                    </div>
                </form>
            </div>
                ...
                <div class="panel panel-default table-responsive">
                    <table id="goodsinfo" class="table table-striped table-bordered templatemo-user-table">
                        ...
                        <tr>
                            ...
                            <td><a href="" class="white-text templatemo-sort-by">满<span class="caret"></span></a></td>
                            <td><a href="" class="white-text templatemo-sort-by">减<span class="caret"></span></a></td>
                            <td>删除</td>
                            <td>编辑</td>
                        </tr>
                        </thead>
