...
$().ready(function(){
    //设置分页要跳转到的url
	$("body").data("url","myorderAction_listRefundOrder.action");
	//声明分页的事件
	SportShopUtils.basedata.initEvent();
	adminAllOrder.agreeRefund();
});
</script>
<body>
<!-- Left column -->
                            ...
                            <div class="panel-body">
                                <div>
                                            ...
                                            <table id="orderinfo" class="table table-striped table-bordered templatemo-user-table goods-table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="" class="white-text templatemo-sort-by">收货地址<span
                                                            class="caret"></span></a></td>
                                                    <c:if test="${order.logistics != null}">
                                    ...
                                    <div class="margin-bottom-10">
                                        <button class="templatemo-edit-btn pull-right" name="agree">同意退款</button>
