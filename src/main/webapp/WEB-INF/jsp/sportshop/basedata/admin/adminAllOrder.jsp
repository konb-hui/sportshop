...
$().ready(function(){
    //设置分页要跳转到的url
	$("body").data("url","myorderAction_listOrderForAdmin.action");
	//声明分页的事件
	SportShopUtils.basedata.initEvent();
	adminAllOrder.sendGood();
});
</script>
<body>
<!-- Left column -->
<div class="modal fade" id="send-order" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content" id="parentModal">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">选择物流</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" id="update-form" name="update-form" method="post">
                    <div class="form-group">
                        <label for="coname" class="col-sm-2 control-label">物流</label>
                        <div class="col-sm-9">
                            <select id="logistics">
                            	<c:forEach items="${logisticses}" var="logistics">
                            		<option value="${logistics.lid}">${logistics.lname}</option>
                            	</c:forEach>
                            </select>
                        </div>
                    </div>
                            ...
                            <div class="panel-body">
                                <div>
                                    ...
                                    <div class="margin-bottom-10">
                                        <button class="templatemo-edit-btn pull-right" name="send">发货</button>
