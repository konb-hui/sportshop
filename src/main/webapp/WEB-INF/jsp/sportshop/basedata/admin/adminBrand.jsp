...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/adminBrand.js"></script>
...
<body>
<div class="modal fade" id="update-brand" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="update-form" name="update-form" method="post">
                   <div class="form-group">
                        <label for="bid" class="col-sm-2 control-label">id</label>
                        <div class="col-sm-9">
                            <span id="updatebid" class="form-control"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="name" class="col-sm-2 control-label">品牌名</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="updatebname" id="updatebname">
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="add-form" name="add-form" method="post">
                    <div class="form-group">
                        <label for="name" class="col-sm-2 control-label">品牌名</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="addbname" id="addbname">
                        </div>
                    </div>
                </form>
            </div>
...
<div class="templatemo-flex-row">
    ...
    <div class="templatemo-content col-1 light-gray-bg">
		...
		<input type="button" param="1" flag="firstPage" value="首页" />&nbsp;<input type="button" flag="prePage" param="${brands.currentPage-1}" value="上一页" />&nbsp;<input type="button" param="${brands.currentPage+1}" flag="nextPage" last="${brands.totalPages}" value="下一页" "/>&nbsp;<input type="button" param="${brands.totalPages}" flag="lastPage" value="尾页" />&nbsp;<span>转到第<input name="basedataQuery.currentPage" id="pageNo" type="text" value="${brands.currentPage}" size="4" style="height:16px; width:28px; border:1px solid #999999; background:#FFF; border-radius:0;" />页 </span>&nbsp;&nbsp;<input type="button" last="${brands.totalPages}" id="jump" value="转" style=" padding:0 10px;"/>
	</span>&nbsp;&nbsp;共有${brands.totalSize}条记录，当前第 ${brands.currentPage}/${brands.totalPages}页</p>
                    </div>
    </div>
</div>
