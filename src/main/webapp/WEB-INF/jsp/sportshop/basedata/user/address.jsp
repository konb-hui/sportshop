        ...
        <div class="modal-content" id="parentModalInsert">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" id="insert-form" name="insert-form" method="post">
                   ...
                   <div class="form-group" style="display: none" id="detailaddressError">
                        <label for="name" class="col-sm-2 control-label"></label>
                        <div class="col-sm-9">
                            <label style="color: #BD1F3B" id="detailaddressLabel"></label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="name" class="col-sm-2 control-label">收货人</label>
                   ...
                   <div class="form-group" style="display: none" id="nameError">
                        <label for="name" class="col-sm-2 control-label"></label>
                        <div class="col-sm-9">
                            <label style="color: #BD1F3B" id="nameLabel"></label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="telephone" class="col-sm-2 control-label">手机号</label>
                    ...
                    <div class="form-group" style="display: none" id="telephoneError">
                        <label for="name" class="col-sm-2 control-label"></label>
                        <div class="col-sm-9">
                            <label style="color: #BD1F3B" id="telephoneLabel"></label>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="mdl-grid demo-content" id="parent">
            <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
                <div class="tab-content">
                    <table class="table" cellpadding="6" cellspacing="1" address-id="${item.aid}" id="table">
                        <thead>
