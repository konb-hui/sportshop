        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="update-form" name="update-form" method="post">
                    ...
                    <div class="form-group" style="display: none" id="usernameError">
                        <label for="name" class="col-sm-2 control-label"></label>
                        <div class="col-sm-9">
                            <label style="color: #BD1F3B" id="usernameLabel"></label>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group" style="display: none" id="emailError">
                        <label for="name" class="col-sm-2 control-label"></label>
                        <div class="col-sm-9">
                            <label style="color: #BD1F3B" id="emailLabel"></label>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group" style="display: none" id="phoneError">
                        <label for="name" class="col-sm-2 control-label"></label>
                        <div class="col-sm-9">
                            <label style="color: #BD1F3B" id="phoneLabel"></label>
                        </div>
                    </div>
                </form>
            </div>
                ...
                <div class="tab-content">
                        <table class="table" cellpadding="6" cellspacing="1">
                            ...
                            <tr >
                                ...
                                <td style="border: 0px solid transparent" class="tr" id="userIdVal">${user.uid}</td>
                            </tr>
                             <tr >
                                <th style="border: 0px solid transparent" class="tl">账号名</th>
                                <td style="border: 0px solid transparent" class="tr" id="account">${user.account}</td>
                            </tr>
                            <tr>
                                <th style="border: 0px solid transparent" class="tl">用户名</th>
                                <td style="border: 0px solid transparent" class="tr" id="usernameVal">${user.username}</td>
                            </tr>
                            <tr>
