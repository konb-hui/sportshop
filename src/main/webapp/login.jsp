			...
			<div class="row">
				...
				<div class="col-md-5 form-login">
					<div>
						...
						<form class="form-horizontal" id="form2" action="loginAction_checkLogin" method="post">
							...
							<div class="form-group">
								...
								<img src="loginAction_getVerificationcodeimg" id="code" onclick="changeImg()"
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-10">
									<input type="submit" class="btn btn-primary login-input" value="登录"
										name="submit">
									<a href="registerAction_register" style="margin-left:10px;">没有账号?去注册</a>
									<div class="error">
										${errorMsg}
									</div>
								</div>
